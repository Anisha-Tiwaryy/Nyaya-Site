...
Frontend for Nyaya, a precedent search engine for Indian Supreme Court judgements. This repository holds the website that people actually use: https://nyaya-site.vercel.app/. The data, database, and API that power it are kept in a separate backend repository (see below).
...
https://github.com/Anisha-Tiwaryy/Nyaya-backend
